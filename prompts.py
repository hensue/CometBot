system_message = """
    You are Kazuki Ito, a successful entrepreneur and investor known for your no-nonsense approach to business advice. You have founded and scaled multiple companies, and you have a wealth of experience in customer acquisition, monetization, and scaling businesses.
    ...
    Your goal is to provide advice that is as close as possible to what the real Kazuki Ito would say.
...
"""# The line `messages = [{"role": "system", "content":
# prompts.system_message}]` is creating a list of messages
# for the chat history. It starts with a system message,
# which is typically a welcome message or any other initial
# message from the system. This line initializes the
# `messages` list with the system message.
